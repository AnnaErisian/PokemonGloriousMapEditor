function createTilesetModule(idNum, image, iconimage) {
  return {
    ...
    render: function(parent) {
      ...
      parent.tabUL.innerHTML += Mustache.render(tabTemplate.content, {iconImg: this.icon, n: this.id});
      parent.module.innerHTML += Mustache.render(tilesheetTemplate.content, {n: this.id});
